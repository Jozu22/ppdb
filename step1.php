<div class="step active container mt-5">
    <h3 class="step-title text-center">Data Anak</h3><br>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="suku" id="jawa" value="Jawa" checked>
            ...
            <div class="mb-3">
                ...
                <div class="container">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="kelas" name="kelas" placeholder="Masuk SD ini dikelas">
                    </div>
                </div>
            </div>
            <!-- </form> -->
